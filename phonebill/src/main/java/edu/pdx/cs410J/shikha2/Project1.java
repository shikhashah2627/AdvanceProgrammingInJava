...
public class Project1 {
     ...
     * @param date
     */
    public void check_date_format(String date) {
     ...
     * @param time
     */
    public void check_time_format(String time) {
    ...
    public static void main(String[] args) {
        ...
        for (String arg : args) {
            if (name == null) {
                ...
                start_date = arg;
                pro_obj.check_date_format(start_date);
            } else if (start_time == null) {
                start_time = arg;
                pro_obj.check_time_format(start_time);
            } else if (end_date == null) {
                end_date = arg;
                pro_obj.check_date_format(end_date);
            } else if (end_time == null) {
                end_time = arg;
                pro_obj.check_time_format(end_time);
            }
